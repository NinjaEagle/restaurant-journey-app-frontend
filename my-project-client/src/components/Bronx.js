                     ...
                     <div className="center"> 
                       ...
                       <h2>You chose {this.state.cuisineName}. </h2> 
                            <h2>Here are your options:</h2>
                                {this.renderRestaurants().map(restaurant => {return <div className="restaurants"><NavLink to={`/restaurant/${restaurant.id}`} className="navlink-restaurant" id={restaurant.name}> score={restaurant.score} {restaurant.name}</NavLink></div>})}
