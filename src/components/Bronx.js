...
export default class Bronx extends Component {
  ...
  getCuisines = data => {
    ...
    let cuisines = bronxrest.map(rest => {
      return rest.cuisine;
    });
  ...
  renderRestaurants = () => {
    return this.state.restaurants.filter(
      rest => rest.cuisine === this.state.cuisineName
    );
  };
        ...
        {this.state.cuisineChosen ? (
          ...
          <div>
            <h2>
              ...
              <br />
              This is the first stop on your restaurant journey.
            </h2>
            <img src={FordhamRoad} alt="fordham-road" />
            <br />
            <h3>
              Home to many different cultures and cuisines, The Bronx has been a
              hub of variety for decades.
            </h3>
